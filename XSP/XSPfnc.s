...
*==========================================================================
*
*	xsp_pcgdat_set(void *pcg_dat, char *pcg_alt, short alt_size);
*
*==========================================================================
...
*==========================================================================
*
*	xsp_pcgmask_on(short start_no, short end_no);
*
*==========================================================================
...
*==========================================================================
*
*	xsp_pcgmask_off(short start_no, short end_no);
*
*==========================================================================
...
*-------[ MFP の復活 ]
	...
	move.l	vektor_118_bak,$118	* V-disp ベクタ復活
	move.l	vektor_138_bak,$138	* CRT-IRQ ベクタ復活
	move.w	raster_No_bak,$E80012	* CRT-IRQ ラスタ No. 復活
...
*==========================================================================
*
*	xsp_hsyncint_on(void *time_chart);
*
*==========================================================================
...
*==========================================================================
*
*	xsp_auto_adjust_divy(short flag);
*
*==========================================================================
